...
public class DB {
	...
	public static Connection DBConnection()
	{
		...
		try
		{
			...
			ss="show databases like 'hell'";
			int s=st.executeUpdate(ss);
			if(s==0)
			{
			System.out.println("its me");
			ss="create database hell";
			st.executeUpdate(ss);
			ss="use hell";
			st.executeUpdate(ss);
			ss="CREATE TABLE sale (ProductID int(11) NOT NUll PRIMARY KEY,Company varchar(30) NOT NUll,date date NOT NUll,Quantity int(11) NOT NUll,Payment int(11) NOT NUll,Name varchar(20) NOT NUll)";
			st.execute(ss);
			ss="CREATE TABLE stock (ProductID varchar(11) NOT NULL PRIMARY KEY,Detail varchar(200) NOT NULL,Company varchar(30) NOT NULL,Quantity varchar(10) NOT NULL)";
			st.executeUpdate(ss);
			ss="CREATE TABLE users (Email varchar(40) NOT NULL PRIMARY KEY,Password varchar(20) NOT NULL)";
			st.executeUpdate(ss);
			ss="INSERT INTO users(Email,Password) VALUES ('admin','123')";
			st.executeUpdate(ss);
			}
			else
			{

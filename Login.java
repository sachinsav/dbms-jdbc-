...
//					Process process = Runtime.getRuntime().exec("E:\\xampp\\apache_start.bat");
	...
	void GUI()
	{
		...
		lblCaddeyLogin = new JLabel("Vcet LogIn");
		lblCaddeyLogin.setFont(new Font("Tahoma", Font.PLAIN, 17));
		lblCaddeyLogin.setBounds(284, 52, 167, 28);
		contentPane.add(lblCaddeyLogin);
		
		label = new JLabel("");
		label.setIcon(new ImageIcon("C:\\XAMPP\\htdocs\\logo.png"));
		label.setBounds(160,10 , 205, 108);

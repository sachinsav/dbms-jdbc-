...
static int kk=0;
	public static void makePdf(Object[] data,long total,int inv)
	{
		...
		String invoice="invoice_"+ii+".pdf";
		Document document = new Document();
	        ...
	        Paragraph p1= new Paragraph("VCET STORE",f1);
	    
	        Paragraph p2= new Paragraph("K.T. Marg,Vasai Road(w)");
	        Paragraph p3= new Paragraph("0250-2338234\n\n\n");
	        ...
	        Paragraph p5= new Paragraph("\nThank you for visiting us…!!\nReturn/Exchange not possible with-out bill.");
	         ...
	         ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phrase, 470, 770, 0);
	         ...
	         Image image;
			try {
				  image = Image.getInstance("C:\\XAMPP\\htdocs\\logo.png");
